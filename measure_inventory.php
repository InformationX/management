	...
	<body>
		...
		<main role="main">
			...
			<div class="container-fluid">
				...
				<h2 class="featurette-heading mt-7 mb-5 text-center">管理番号を登録して棚卸しをする</h2>
				<form class="form-invenroty" method="post" action="">
					<div class="textboxArea mt-3">
						<input type="text" class="form-control textbox-inventory" name="id-001" placeholder="管理番号を入力してください" autofocus>
					</div>
					<button type="button" class="btn btn-danger add" id="addButton">欄を追加</button>
					<button type="button" onclick="submit()" class="btn btn-primary">登録へ進む</button>
				</form>
				...
				<hr class="featurette-divider">
				<h2 class="featurette-heading mt-7 mb-5 text-center">棚卸し状況を確認する</h2>
				<hr class="featurette-divider">
